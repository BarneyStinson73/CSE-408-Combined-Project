...
// };
    ...
    function calculatePosition(){
        ...
        arrowPosition = {
           ...
           arrowheadPoints: `${toTaskRect.left + toTaskRect.width / 2 - 20},${toTaskRect.top} ${toTaskRect.left + (toTaskRect.width / 2) - 30},${toTaskRect.top - 10} ${toTaskRect.left + toTaskRect.width / 2 - 10},${toTaskRect.top - 10}`
        };
    }
...
>
  {#if arrowPosition}
    <line
      ...
      stroke-width="2"
    />
    <polygon points={arrowPosition.arrowheadPoints} fill="green" />
  {/if}
</svg>
