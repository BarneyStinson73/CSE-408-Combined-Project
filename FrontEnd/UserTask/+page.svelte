    ...
    onMount(async () => {
      console.log("I am in on mount")
        ...
        try{
            ...
            userTest = dataBackend.userProfile_userInfo;
            tagList = Array.from(dataBackend.returnExpertise);
            userTasks = Array.from(dataBackend.userProfile_taskInfo);
            userTaskAssignmentReq = Array.from(dataBackend.userProfile_taskAssignmentReq);
            console.log(dataBackend);
            console.log(userTest);
            console.log(userTasks);
            console.log(userTaskAssignmentReq);
            // user = dataBackend.userProfile_userInfo;
            // tags = dataBackend.returnExpertise;
...
async function updatePassword(event){
 ...
 async function updateProfile(event){
    ...
    const response = await axios.post(`http://localhost:9000/api/user/${userId}/profile/update`, dataToSend);
  ...
  //console.log(user);
  // $: if(userTasks){
  //   //console.log("I am in userTasks");
  //   //console.log(userTasks);
  // }
  // $: if(userTaskAssignmentReq){
  //   //console.log("I am in userTaskAssignmentReq");
  //   //console.log(userTaskAssignmentReq);
  // }
  // console.log(userTaskAssignmentReq);
  // console.log(userTasks);
...
<div class = 'flex flex-row bg-yellow-50 z-10'>
    ...
    <div class=' mt-12'>
        ...
        <p>Contact No:{userTest.contactNo}</p>
        <!-- <p>Status: {user.type.charAt(0).toUpperCase() + user.type.slice(1)}</p> -->
        <p>Email:{userTest.email}</p>
        <!-- <p>Currently Available:{userTest.isAvailable?("Yes"):("No")}</p> -->
    </div>  
</div>
...
<!--
    ...
    <div class='mt-10 ml-10 flex-grow'>
      {#if !isLoading}
        <UserTask userTasks={userTasks} userTaskAssignmentReq={userTaskAssignmentReq} userId={userId}/>
      {/if}
        <!-- <UserTask /> -->
