<script>
	...
	async function task_creation() {
		...
		if (res.ok) {
			...
			if (data.success) {
				alert('Task Created from project Successfully');
			}
		}
	}
</script>

<div class="m-auto grid h-screen w-1/2 grid-cols-1 items-center">
	<form class="h-3/4 rounded bg-blue-100 px-10" on:submit|preventDefault={task_creation}>
