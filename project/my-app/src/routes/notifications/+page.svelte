    ...
    <!-- <div class="w-full h-full bg-gray-800 bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden fixed sticky-0 z-50 bg-cover h-full" style="background-image: url('./src/routes/notification/NotificationImage.jpeg');" id="chec-div"> -->
        <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
        <!-- <div class='flex flex-row'>
        <div class='basis-1/2'></div> -->
        <!-- <div class="w-full absolute z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700 basis-1/2" id="notification">
            <div class="2xl:w-4/12 bg-gray-50 h-screen overflow-y-auto p-8 absolute right-0">
                <div class="flex items-center justify-between">
                    <p tabindex="0" class="focus:outline-none text-2xl font-semibold leading-6 text-gray-800">Notifications</p>
                     <button role="button" aria-label="close modal" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 rounded-md cursor-pointer" >
                ...
                <div class="w-full p-3 mt-8 bg-white rounded flex">
                    ...
                    <div class="pl-3">
                        <p tabindex="0" class="focus:outline-none text-sm leading-none">James Doe favourited an item</p>
                ...
                <div class="w-full p-3 mt-4 bg-white rounded shadow flex flex-shrink-0">
                    ...
                    <div class="pl-3 w-full">
                        <div class="flex items-center justify-between w-full">
                            <p tabindex="0" class="focus:outline-none text-sm leading-none">Sash added you to the group: UX Designers</p>
                ...
                <div class="w-full p-3 mt-4 bg-white rounded flex">
                    ...
                    <div class="pl-3">
                        <p tabindex="0" class="focus:outline-none text-sm leading-none">Sarah posted in the thread: Update gone wrong</p>
                        <p tabindex="0" class="focus:outline-none text-xs leading-3 pt-1 text-gray-500">2 hours ago</p>
                    </div>
                </div>
                ...
                <div class="w-full p-3 mt-4 bg-white rounded flex">
                    ...
                    <div class="pl-3">
                        <p tabindex="0" class="focus:outline-none text-sm leading-none">Shipmet delayed for order #25551</p>
                        <p tabindex="0" class="focus:outline-none text-xs leading-3 pt-1 text-gray-500">2 hours ago</p>
                    </div>
                </div>
